...
<div class="register">
  <form action='/registerT' method='POST'>
    ...
    <input type='url' name='linkedin' placeholder='Votre compte linkedin (optionel)' class="champsform">
    <input type='url' name='portfolio' placeholder='Votre portfolio (optionel)' class="champsform">
